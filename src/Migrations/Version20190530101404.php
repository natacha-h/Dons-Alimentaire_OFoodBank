 ...
 */
final class Version20190530101404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE donation (id INT AUTO_INCREMENT NOT NULL, giver_id INT DEFAULT NULL, collector_id INT DEFAULT NULL, status_id INT DEFAULT NULL, address_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, picture VARCHAR(150) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_31E581A075BD1D29 (giver_id), INDEX IDX_31E581A0670BAFFE (collector_id), INDEX IDX_31E581A06BF700BD (status_id), INDEX IDX_31E581A0F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
